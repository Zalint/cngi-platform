    ...
    open() {
        ...
        overlay.innerHTML = `
            <div class="confirm-dialog" style="text-align:left;max-width:500px;">
                <h3 style="margin-bottom:8px;color:var(--color-text);display:inline-flex;align-items:center;gap:8px;">${Icon.render('key', 18, 'currentColor')} Changer le mot de passe</h3>
