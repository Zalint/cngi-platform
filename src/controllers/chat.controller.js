    ...
    try {
        ...
        if (name === 'list_pv') {
            ...
            return pvs.map(p => ({
                ...
                notes: p.content,
                auteur: [p.author_first_name, p.author_last_name].filter(Boolean).join(' ') || p.author_username || null,
        ...
        if (name === 'get_pv') {
            ...
            return {
                ...
                notes: pv.content,
                auteur: [pv.author_first_name, pv.author_last_name].filter(Boolean).join(' ') || pv.author_username || null,
